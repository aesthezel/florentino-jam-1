## [3.3.0] - 2024-10-11
- Fix References with Playmaker Actions
- Fix OnValueChanged Object display with Playmaker Actions
- Fix Runtime value being shown in the inspector
- Fix Bindings not always refreshing value when modified from Inspector
- Add Support for Game Creator 2
- Add Variable Reference usage for min and max Value of Int and Float Variables
- Add option to use MaxValue from Int and Float Variables in Bindings
- Add option to enable raising Scriptable Events from the inspector
- Add shortcuts support to Soap Wizard 
- Add Soap Settings in Preferences Window
- Add FloatReference for Delay field in EventListeners

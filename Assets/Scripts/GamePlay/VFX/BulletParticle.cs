...
{
    public class BulletParticle : MonoBehaviour, IPoolElement
    {
        [SerializeField] private ParticleSystem particle;
        
        private FlexibleMonoBehaviorPool<BulletParticle> _parentPool;
        public void SetParentPool<T>(FlexibleMonoBehaviorPool<T> pool) where T : MonoBehaviour, IPoolElement
        {
            _parentPool = pool as FlexibleMonoBehaviorPool<BulletParticle>;
        }
